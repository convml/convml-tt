...
from torchvision.datasources.utils import download_and_extract_archive
...
_checks = {}
_checks[ExampleData.EUREC4A_SMALL] = "2e19801de21608968d107ac01ecf2a3b"


def _fetch_example(item: ExampleData, data_dir="data/"):
    """
...
def fetch_example_datasource(datasource: ExampleData, data_dir="data/"):
    """
    Downloads example datasource and returns the path to it
    """
...
def main(args=None):
    ...
    argparser.add_argument("datasource_name", choices=[ds.name for ds in ExampleData])
    ...
    datasource_path = fetch_example_datasource(
        datasource=ExampleData[args.datasource_name], data_dir=args.path
    )
